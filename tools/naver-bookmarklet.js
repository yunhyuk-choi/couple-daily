  ...
  function processNative(u) {
    ...
    function extractMetas(results) {
      ...
      for (var r = 0; r < results.length; r++) {
        ...
        if (url) out.push({ idx: r, meta: { displayUrl: url, path: path, width: width, height: height, fileSize: fileSize, fileName: fileName } });
      }
      return out;
    }
