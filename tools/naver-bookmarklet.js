  ...
  function processNative(u) {
    ...
    function extractMetas(results) {
      ...
      for (var r = 0; r < results.length; r++) {
        ...
        // 서빙 가능한 URL 조립. resp.url 은 이미 /fileName 을 포함하므로 그대로 사용(절대화만).
        // url이 없을 때만 path + '/' + fileName 으로 폴백 조립한다.
        var base = '';
        if (rawUrl) {
