    ...
    return edWin().fetch(url, { method: 'POST', credentials: 'include', body: fd })
      .then(function (r) {
        return r.text().then(function (t) {
          ...
          diag('업로드[' + idx + '] url=' + nu);
          if (!nu) throw new Error('응답에서 URL 못 찾음(' + t.slice(0, 120) + ')');
          return nu;
        });
      });
  }
